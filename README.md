...
Docs to use the library can be found [here](https://pkg.go.dev/github.com/munjalpatel/pg-schema-diff). Check out [the CLI](https://github.com/munjalpatel/pg-schema-diff/tree/main/cmd/pg-schema-diff)
